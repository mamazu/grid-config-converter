...
class SyliusAdminOrder extends AbstractGrid
{
    ...
    public function buildGrid(GridBuilderInterface $gridBuilder) : void
    {
        $gridBuilder
            ...
            ->addField(DateTimeField::create('date')
            ->setEnabled(false)
            ...
            ->addField(TwigField::create('number', '@SyliusAdmin/Order/Grid/Field/number.html.twig')
            ...
            ->addField(TwigField::create('channel', '@SyliusAdmin/Order/Grid/Field/channel.html.twig')
            ->setLabel('sylius.ui.channel')
            ->setSortable(true, 'channel.code')
            ->setOptions([
                'template' => '@SyliusAdmin/Order/Grid/Field/channel.html.twig',
            ]))
            ->addField(TwigField::create('customer', '@SyliusAdmin/Order/Grid/Field/customer.html.twig')
            ->setLabel('sylius.ui.customer')
            ->setSortable(true, 'customer.lastName')
            ->setOptions([
                'template' => '@SyliusAdmin/Order/Grid/Field/customer.html.twig',
            ]))
            ->addField(TwigField::create('state', '@SyliusUi/Grid/Field/state.html.twig')
            ...
            ->addField(TwigField::create('paymentState', '@SyliusUi/Grid/Field/state.html.twig')
            ...
            ->addField(TwigField::create('shippingState', '@SyliusUi/Grid/Field/state.html.twig')
            ...
            ->addField(TwigField::create('total', '@SyliusAdmin/Order/Grid/Field/total.html.twig')
            ...
            ->addField(StringField::create('currencyCode')
            ->setLabel('sylius.ui.currency')
            ->setSortable(true))
            ->addFilter(Filter::create('number', 'string')
            ->setLabel('sylius.ui.number'))
            ->addFilter(Filter::create('customer', 'string')
            ->setLabel('sylius.ui.customer')
            ->setOptions([
                'fields' => [
                    'customer.email',
            ...
            ->addFilter(Filter::create('date', 'date')
            ->setLabel('sylius.ui.date')
            ->setOptions([
                'field' => 'checkoutCompletedAt',
                'inclusive_to' => true,
            ]))
            ->addFilter(Filter::create('channel', 'entity')
            ->setLabel('sylius.ui.channel')
            ->setFormOptions([
                'class' => '%sylius.model.channel.class%',
            ]))
            ->addFilter(Filter::create('total', 'money')
            ->setLabel('sylius.ui.total')
            ->setOptions([
                'currency_field' => 'currencyCode',
            ]))
            ->addFilter(Filter::create('shipping_method', 'entity')
